...
fun CustomComponent(
    ...
    backgroundIndicatorColor: Color = MaterialTheme.colorScheme.surface.copy(alpha = 0.5f),
    ...
    val animatedBigTextColor by animateColorAsState(
        ...
        else bigTextColor, animationSpec = tween(durationMillis = 1000), label = ""
    )
...
fun CustomComponentPreview() {
    Column(
        ...
        CustomComponent(indicatorValue = value, indicatorStrokeCap = StrokeCap.Square)
